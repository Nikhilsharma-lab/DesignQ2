...
function RichRequestCard({
  ...
  return (
    ...
    >
      <div className="rounded-xl border bg-card p-3.5 transition-colors group-hover:bg-accent/50">
...
function MediumRequestCard({
  ...
  return (
    <Link
      ...
      className="block no-underline group"
    >
      <div className="rounded-xl border bg-card p-3.5 transition-colors group-hover:bg-accent/50 h-full">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            <p className="text-sm font-medium text-foreground truncate">
              {request.title}
...
function CompactRequestRow({
  ...
  return (
    <Link
      href={`/dashboard/requests?dock=${request.id}`}
      className="flex items-center gap-3 px-3.5 py-2.5 no-underline transition-colors hover:bg-accent/50 first:rounded-t-xl last:rounded-b-xl"
    >
